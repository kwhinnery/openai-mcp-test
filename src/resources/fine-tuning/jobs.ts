...
import * as GradersAPI from './alpha/graders';
...
export class Jobs extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.fineTuning.jobs.listCheckpoints(
   *     'ft-AF1WoRqd3aJAHsqc9NY7iL8F',
   *   );
   * ```
   */
  listCheckpoints(
    ...
    query: JobListCheckpointsParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<JobListCheckpointsResponse> {
    return this._client.get(path`/fine_tuning/jobs/${fineTuningJobID}/checkpoints`, { query, ...options });
  }
   ...
   * @example
   * ```ts
   * const response = await client.fineTuning.jobs.listEvents(
   *   'ft-AF1WoRqd3aJAHsqc9NY7iL8F',
   * );
   * ```
   */
  listEvents(
    ...
    options?: RequestOptions,
  ): APIPromise<JobListEventsResponse> {
    return this._client.get(path`/fine_tuning/jobs/${fineTuningJobID}/events`, { query, ...options });
  }
...
export interface FineTuneMethod {
   ...
   */
  dpo?: FineTuneMethod.Dpo;

  /**
   * Configuration for the reinforcement fine-tuning method.
   */
  reinforcement?: FineTuneMethod.Reinforcement;

  /**
   * Configuration for the supervised fine-tuning method.
   */
  supervised?: FineTuneMethod.Supervised;
}
...
export namespace FineTuneMethod {
  ...
  export interface Reinforcement {
     ...
     */
    grader:
      | GradersAPI.GraderStringCheckFineTuning
      | GradersAPI.GraderTextSimilarityFineTuning
      | GradersAPI.GraderPythonScript
      | GradersAPI.GraderScoreAssignmentModel
      | GradersAPI.GraderMulti;

    /**
     * The hyperparameters used for the reinforcement fine-tuning job.
     */
    hyperparameters?: Reinforcement.Hyperparameters;
  }

  export namespace Reinforcement {
    /**
     * The hyperparameters used for the reinforcement fine-tuning job.
     */
    export interface Hyperparameters {
...
export interface JobListCheckpointsResponse {
  data: Array<JobListCheckpointsResponse.Data>;
...
export namespace JobListCheckpointsResponse {
  /**
...
export interface JobListEventsResponse {
  data: Array<JobListEventsResponse.Data>;
...
export namespace JobListEventsResponse {
  /**
...
export interface JobListCheckpointsParams {
  /**
