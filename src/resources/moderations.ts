...
export class Moderations extends APIResource {
   ...
   * ```
   */
  classify(body: ModerationClassifyParams, options?: RequestOptions): APIPromise<ModerationClassifyResponse> {
 ...
 */
export interface ModerationClassifyResponse {
  /**
   ...
   */
  results: Array<ModerationClassifyResponse.Result>;
}

export namespace ModerationClassifyResponse {
...
export interface ModerationClassifyParams {
  /**
  ...
  input:
    | string
    | Array<string>
    | Array<ModerationClassifyParams.UnionMember0 | ModerationClassifyParams.UnionMember1>;
...
export namespace ModerationClassifyParams {
  /**
